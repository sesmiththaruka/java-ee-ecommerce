                ...
                <div class="product-box mb-md-20">
                    ...
                    <div class="product-caption">
                        ...
                        <div class="product-btn">
                            <a href="order-details.html" class="btn-first white-btn full-width text-light-green fw-600">Track
                                Order</a>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-3 col-md-4">
                <div class="large-product-box mb-xl-20 p-relative">
                    ...
                    <div class="category-type overlay padding-15">
                        ...
                        <a href="restaurant.html" class="btn-first white-btn text-light-black fw-600 full-width">See
                            all</a>
                    </div>
                </div>
            </div>
...
<%--                   product view--%>
    <c:forEach var="category" items="${category}">
        ...
        <div class="col-lg-4 col-md-6 col-sm-6" onclick="goToSingleProduct(${category.id})">
            <div class="product-box mb-xl-20">
                ...
                <div class="product-caption">
                    <div class="title-box">
                        <h6 class="product-title"><a class="text-light-black ">${category.name}</a></h6>
                        <div class="tags"> <span class="text-custom-white rectangle-tag bg-yellow">
                        3.1
                      </span>
                        </div>
                    </div>
<%--                    <p class="text-light-white">${product.description}</p>--%>
                    <div class="product-details">
                        <div class="price-time"><span class="text-light-black time">\\\</span>
<%--                            <span class="text-light-white price">${product.price}</span>--%>
                        </div>
