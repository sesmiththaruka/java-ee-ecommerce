                ...
                <div class="row">
                  <div class="col-lg-6 col-md-12 col-sm-6">
                    <div class="form-group">
                      ...
                      <input type="text" id="fname"  class="form-control form-control-submit" placeholder="First Name" required>
                    </div>
                  </div>
                  <div class="col-lg-6 col-md-12 col-sm-6">
                    <div class="form-group">
                      <label class="text-light-white fs-14">Last name</label>
                      <input type="text" id="lname" class="form-control form-control-submit" placeholder="Last Name" required>
                    </div>
                  </div>
                  <div class="col-12">
                    <div class="form-group">
                      <label class="text-light-white fs-14">Email</label>
                      <input type="email" name="#" id="email" class="form-control form-control-submit" placeholder="Email I'd" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      <button class="btn-second btn-submit full-width sign-up">Create your account</button>
                    </div>
...
<script type="text/javascript">
  let e = document.getElementsByClassName('sign-up').item(0).addEventListener('click',function (){
